...
Should be noted that the inspiration for this project came from 'Harry Potter and the Philosophers Stone', so note the references to it over the span of the
project.
